...
export function IconPickerDialog({
  ...
  return (
    <dialog
      ...
      className="m-auto w-full max-w-2xl rounded-2xl border border-slate-200 bg-white p-0 shadow-2xl backdrop:bg-slate-900/40 dark:border-white/10 dark:bg-neutral-900 dark:backdrop:bg-black/60"
    >
        ...
        <div className="border-b border-slate-200 p-5 dark:border-white/10">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="ml-auto rounded-lg p-2 text-slate-600 hover:bg-slate-100 dark:text-neutral-400 dark:hover:bg-neutral-800"
            >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-5">
          <button
            ...
            className={`mb-5 flex w-full items-center gap-2 rounded-xl border px-3 py-2 text-sm font-medium transition-colors ${
              value === ''
                ? 'border-indigo-500 bg-indigo-50 text-indigo-900 dark:border-indigo-400 dark:bg-indigo-500/15 dark:text-indigo-200'
          ...
          {gefiltert.map((group) => (
            <section key={group.titel} className="mb-5 last:mb-0">
              <h3 className="mb-2 text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-neutral-400">
                {group.titel}
              </h3>
                    ...
                    <button
                      ...
                      className={`flex aspect-square items-center justify-center rounded-xl border transition-colors ${
                        gewaehlt
                          ...
                          : 'border-slate-200 text-slate-600 hover:border-slate-400 hover:bg-slate-50 dark:border-white/10 dark:text-neutral-400 dark:hover:border-white/25 dark:hover:bg-white/5'
                      }`}
                    >
